...
namespace Partys.ApplicationServices.GetPartyListUseCase
{
    public class GetPartyListUseCase : IGetPartyListUseCase
    {
        ...
        public async Task<bool> Handle(GetPartyListUseCaseRequest request, IOutputPort<GetParyListUseCaseResponse> outputPort)
        {
            ...
            outputPort.Handle(new GetParyListUseCaseResponse(partys));
            return true;
        }
    }
}
